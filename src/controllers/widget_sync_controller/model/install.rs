...
pub open spec fn widget_disturber_controller_model() -> ControllerModel {
    ControllerModel {
        reconcile_model: Cluster::installed_reconcile_model::<WidgetDisturberReconciler, WidgetDisturberReconcileState, InnerWidgetView, VoidEReqView, VoidERespView>(),
        external_model: None,
    }
}
