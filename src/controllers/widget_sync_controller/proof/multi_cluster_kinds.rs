...
// store per binding of the deployment. Nothing here names a kind or a binding.
...
// ---------------------------------------------------------------------------
// The demos: one kind served for two bindings, and two kinds side by side.
// ---------------------------------------------------------------------------

// The fan-out demo (composition::widget_sync_reconciler::widget_fanout_kind):
// one kind, two bindings, three controllers.
